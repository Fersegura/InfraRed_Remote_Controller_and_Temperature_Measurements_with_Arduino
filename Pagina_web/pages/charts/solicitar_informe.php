<?php
  ...
  require_once("../../my_php/database_connect.php"); //We include the database_connect.php which has the data for the connection to the database
...
<html lang="en">
  ...
  <head>
    ...
    <title>Graficos / Solicitar informe</title>
              ...
              <div class="col-lg-12 col-6">
                  <div class="card card-warning card-outline">
                      ...
                      <div class="card-body pad table-responsive">
                        ...
                        <form action="../../my_php/request_informe.php" method="post">
                            <label for="inicio">Desde: </label>
                            <input type="date" id="inicio" min=<?php require_once('../../my_php/func_temp.php'); get_fecha($con, "inicio");?> max=<?php get_fecha($con, "final");?> value=<?php get_fecha($con, "inicio");?> name="from"><br></br>
